...
**Result:** Fully operational cluster with 20+ pods running.
...
**Infrastructure:**
- 2 VMs running Fedora 43 Server (2GB RAM, 2 vCPU each)
- 20GB storage per VM (thin-provisioned from host)
...
- FluxCD managing deployments from Git
...
**Manual steps:** 3 SSH commands (one-time setup)  
